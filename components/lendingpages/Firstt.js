...
import { Alert, StyleSheet, Text, TextInput, View, Switch, Image, Pressable, SafeAreaView, Touchable, ScrollView, ImageBackground } from 'react-native';
...
export default function First({ navigation }) {
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            navigation.navigate('2'); // Replace 'NextScreen' with the name of your next screen
        }, 2000);
